      ...
      <div className="relative ">
          ...
          <div className="my-12 lg:flex justify-between lg:my-20">
            ...
            <div className="grid grid-cols-2 gap-6 my-8 lg:grid-cols-3 lg:w-[60%]">
              <div className="grid_items">
                <img src={Curriculum} alt="Structured Curriculum" className="grid_icon" />
              ...
              <div className="grid_items">
                <img src={Faculty} alt="Faculty Support" className="grid_icon" />
              ...
              <div className="grid_items">
                <img src={Community} alt="Engaging Community" className="grid_icon" />
              ...
              <div className="grid_items">
                <img src={Resources} alt="Comprehensive Resources" className="grid_icon" />
        ...
        <section id='community' className="rule font-[Inter] text-center">
          ...
          <div className="my-12 shadow-lg p-4 rounded-3xl md:flex md:gap-12 md:px-8 md:py-6 md:my-24 lg:gap-18 lg:px-24 lg:py-12 relative bg-[#41A94EE5] z-90 lg:my-36">
            ...
            <img src={CommunityGuy} alt="Student" className='w-full sm:h-[300px] object-contain lg:w-[25%]' />
