        ...
        <header className="rule my-8 md:my-16 ">
          ...
          <div className="md:flex gap-10">
            ...
            <div className="flex flex-col text-black my-4">
              ...
              <button onClick={() => setIsEditModalOpen(!isEditModalOpen)} className="bg-[#41A94E] rounded-4xl py-2 text-white my-2 text-lg font-medium cursor-pointer md:text-3xl md:my-4">Edit Profile</button>
            </div>
          </div>
        </header>
